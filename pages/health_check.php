...
<div id="pageContent">
  ...
  $healFlags = [
      ...
      'heal_abra_cw_20260827'           => 'عبرا: متعاقدون وموظفون على كشفه + حذف غير الخاضعين',
      'heal_abra_cw2_20260827'          => 'عبرا: بلال اسعد وجوزيف بولس (داتا أونلاين منحرفة)',
      'heal_bechara_cw_20260827'        => 'البشارة: متعاقدون وموظفون على كشفه + حذف غير الخاضعين',
      'heal_entikal_cw_20260827'        => 'الانتقال: 5 متعاقدين كانوا ملاكاً + حذف غير الخاضعين',
      'heal_niyah_cw_20260827'          => 'النياح: بياره كانت ملاكاً + حذف غير الخاضعين',
      'heal_ksara_cw_20260827'          => 'كسارة: 8/8 مطابقون + حذف غير الخاضعين الـ12',
      'heal_tia_percent_20260828'       => 'تيا نخلة: الإضافي نسبة 45٪ بقاعدة ÷1500',
      'heal_tia_percent2_20260828'      => 'تيا نخلة: التشخيص (البند/السعر/القاعدة/المخزّن)',
      'heal_tia_percent3_20260828'      => 'تيا نخلة: الحاسمة — خلق بند 45٪ إن غاب + إعادة الحساب',
      'heal_percent_law_20260828'       => '⚖️ قانون النسبة على الجميع: النتيجة + الاستثناءات',
      'heal_percent_law_progress'       => '⚖️ قانون النسبة: تقدّم الدفعات',
      'heal_prime_snapshot_20260828'    => '🔄 مزامنة بنود الإضافي من لقطة الكمبيوتر: النتيجة',
      'heal_prime_snapshot_progress'    => '🔄 مزامنة البنود: تقدّم الدفعات',
      'bk_tia_prime_20260828'           => 'تيا نخلة: نسخة علاوتها القديمة (قبل النسبة)',
      ...
      'heal_niyah_cw3_20260829'         => '🧹 النياح ٣: اسبر منصور (مكرّر) + ندى باصيل + زويا سمعان — إزالة رواتبهم الزائدة (2026-08-29)',
      'heal_dedup_2526_20260902'        => '🧹 المكرّرون بنفس المدرسة: ملف واحد يبقى + دمج رواتب الزائد تحته + حذفه الناعم (2026-09-02)',
      'heal_dedup_fill_20260902'        => '🧩 تكملة الدمج: استكمال خانات الهوية الفاضية عند الباقي من نسخة المُزال (2026-09-02)',
      'heal_new_hires_norows_20260909'  => '🆕 الجديد بلا أساس بالإعداد (متعاقد/موظف من 2026-2027) ومعه علاوة/نقل وبلا أي راتب → يُحسب من ملفه (ريتا بو عاصي) (2026-09-09)',
  ];
  ?>
  <?php
