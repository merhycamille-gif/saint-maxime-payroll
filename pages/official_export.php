...
if ($form === 'mof_r3') {
    ...
    $digits($esch['finance_number'] ?? '', [56.06, 58.16, 60.24, 62.32, 64.39, 66.46, 68.54, 70.61, 72.71], 12.6); // 9 خانات فعلية — «74.91» كانت حافة اللابل لا خانة (p1 13:15)
    ...
    $put($emp['email'] ?? '', 66.0, 75.45, 'r', 8.5); // قاعد على سطر e-mail تماماً (p2 13:16)
