...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($action, ['new', 'edit'])) {
    ...
    $data = [
        ...
        'phone1' => trim(arabicDigitsFr($_POST['phone1'] ?? '')), // «كل الارقام اكتبو بالفرنسي»
        'phone2' => trim(arabicDigitsFr($_POST['phone2'] ?? '')),
            ...
            <div class="card-body">
                ...
                <div style="background:#f0f7ff;border:1px solid #bfdbfe;border-radius:10px;padding:12px 16px;font-size:13px;line-height:1.7">
                    ...
                    <ul style="margin:6px 0 0;padding-inline-start:20px">
                        ...
                        <li>كل سطر = قيمة (ل.ل أو $ أو نسبة٪ من الأساس) + <strong>من شهر إلى شهر</strong>. «كل السنة» = يُدفع كل الأشهر. إذا تغيّرت القيمة خلال السنة أضِف سطراً لكل فترة. <strong>مبلغ بالدولار + مبلغ بالليرة معاً</strong> = سطران بنفس الفترة (يُجمعان).</li>
                ...
                $bonusSection('prime_fixe', '➕ Supplément de salaire', 'الأجر الإضافي',
                    'الإضافي الشهري فوق الأساس (مبلغ مقطوع، أو نسبة٪ من الأساس تتحرّك مع الدرجة). <b>جزء بالدولار وجزء بالليرة؟</b> سطران بنفس الفترة (سطر $ + سطر ل.ل) والبرنامج بيجمعهم. يدخل بحساب الضمان والصندوق والضريبة كالراتب.');
